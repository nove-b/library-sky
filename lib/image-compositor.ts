 ...
 * This is used for BlueSky posting - uses SVG without emoji to avoid Pango font issues
 */
export async function generateCompositeImage(
  ...
  try {
    ...
    // Create SVG for text content (title and author) - no emoji to avoid Pango issues
...
/**
 * Create SVG with title and author text (no emoji to avoid Pango font issues)
 */
